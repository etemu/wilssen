...
static int wID = 01; // Wireless mesh networt ID, octal value from 00 to 05555
static byte wirelessID[] = {wID & 0xFF, (wID >> 8) & 0xFF}; //TODO: verify endianess
static byte nodeID = wirelessID[0]; // range: 2-254
