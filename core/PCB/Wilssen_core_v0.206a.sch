...
<part name="U$3" library="SparkFun-Connectors" deviceset="AVR_SPI_PROG" device=""/>
<part name="U$2" library="SparkFun-Connectors" deviceset="AVR_SPI_PROG" device=""/>
...
<text x="129.54" y="-5.08" size="1.778" layer="95">Based on and designed to be compatible with the Arduino FIO footprint (however, A0-A7 are reversed), some parts are from the Sparkfun Eagle libraries (CC-BY)</text>
...
<instance part="U$3" gate="A" x="193.04" y="17.78"/>
<instance part="U$2" gate="A" x="236.22" y="17.78"/>
